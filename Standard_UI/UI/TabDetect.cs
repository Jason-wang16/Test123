...
{
    public partial class TabDetect : Form
    {
        HTuple hv_StartX;
        HTuple hv_StartY;
        ...
        private void Initialize()
        {
            try
            {
                nudMinGray.Value = tabParams.hv_MinGray;
                nudMaxGray.Value = tabParams.hv_MaxGray;
                nudMin.Value = tabParams.hv_Min;
                nudMax.Value = tabParams.hv_Max;
                nudNumber.Value = tabParams.hv_Number;
        ...
        private void btnSaveTabParams_Click(object sender, EventArgs e)
        {
            FindTab();
        }
        ...
        private void tsmiReadImage_Click(object sender, EventArgs e)
        {
            ...
            if (dialog.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                try
                {
                    ...
                    HOperatorSet.ReadImage(out tabParams.ho_Image, filePath);
                    Show2HWindow(tabParams.ho_Image);
                }
                catch (Exception exc)
                {
        ...
        {
            tabParams.hv_MinGray = Convert.ToInt32(nudMinGray.Value);
        }

        private void nudMaxGray_ValueChanged(object sender, EventArgs e)
        {
            tabParams.hv_MaxGray = Convert.ToInt32(nudMaxGray.Value);
        }

        private void nudMin_ValueChanged(object sender, EventArgs e)
        {
            tabParams.hv_Min = Convert.ToInt32(nudMin.Value);
        }

        private void nudMax_ValueChanged(object sender, EventArgs e)
        {
            tabParams.hv_Max = Convert.ToInt32(nudMax.Value);
        }

        private void nudNumber_ValueChanged(object sender, EventArgs e)
        {
            tabParams.hv_Number = Convert.ToInt32(nudNumber.Value);
        }
        ...
        private void tsmiSaveRegion_Click(object sender, EventArgs e)
        {
            ...
            if (dialog.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                try
                {
                    ...
                    HOperatorSet.WriteRegion(tabParams.ho_Region, filePath);
        ...
        private void tsmiReadRegion_Click(object sender, EventArgs e)
        {
            ...
            if (dialog.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                ...
                {
                    filePath = dialog.FileName;
                    HOperatorSet.ReadRegion(out tabParams.ho_Region, filePath);
        ...
        private void tsmiUnionROI_Click(object sender, EventArgs e)
        {
            ...
            {
                tabParams.ho_Region = ho_Regions.ElementAt(0);
            ...
            else
            {
                ...
                {
                    HOperatorSet.Union2(tabParams.ho_Region, ho_Regions.ElementAt(i), out tabParams.ho_Region);
                }
                MessageBox.Show("合并ROI区域成功，ROI数量为" + ho_Regions.Count().ToString() + "!");
                return;
            }
